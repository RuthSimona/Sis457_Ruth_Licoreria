...
namespace WebLicoreria.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(LabLicoreriaWebContext context)
        {
            _context = context;
        }
        ...
        {
            var labLicoreriaWebContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
            return View(await labLicoreriaWebContext.ToListAsync());
        }
