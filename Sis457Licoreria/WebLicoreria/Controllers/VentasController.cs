...
namespace WebLicoreria.Controllers
{
    public class VentasController : Controller
    {
        ...
        public VentasController(LabLicoreriaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdVenta,NumeroDocumento,TipoPago,FechaRegistro,Total")] Ventum ventum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenta,NumeroDocumento,TipoPago,FechaRegistro,Total")] Ventum ventum)
        {
